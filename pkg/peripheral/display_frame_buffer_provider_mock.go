...
func (_mock *DisplayFrameBufferProviderMock) GetDisplayPixelFormat(ctx context.Context) (*DisplayPixelFormat, error) {
	ret := _mock.Called(ctx)
...
func (_c *DisplayFrameBufferProviderMock_GetDisplayPixelFormat_Call) Return(displayPixelFormat *DisplayPixelFormat, err error) *DisplayFrameBufferProviderMock_GetDisplayPixelFormat_Call {
	_c.Call.Return(displayPixelFormat, err)
	return _c
}

func (_c *DisplayFrameBufferProviderMock_GetDisplayPixelFormat_Call) RunAndReturn(run func(ctx context.Context) (*DisplayPixelFormat, error)) *DisplayFrameBufferProviderMock_GetDisplayPixelFormat_Call {
	_c.Call.Return(run)
	return _c
}
