...
func (_mock *DisplaySourceMock) GetId() Id {
	ret := _mock.Called()
...
func (_c *DisplaySourceMock_GetId_Call) Return(id Id) *DisplaySourceMock_GetId_Call {
	_c.Call.Return(id)
	return _c
}

func (_c *DisplaySourceMock_GetId_Call) RunAndReturn(run func() Id) *DisplaySourceMock_GetId_Call {
	_c.Call.Return(run)
	return _c
}

// GetName provides a mock function for the type DisplaySourceMock
func (_mock *DisplaySourceMock) GetName() Name {
	ret := _mock.Called()
...
func (_c *DisplaySourceMock_GetName_Call) Return(name Name) *DisplaySourceMock_GetName_Call {
	_c.Call.Return(name)
	return _c
}

func (_c *DisplaySourceMock_GetName_Call) RunAndReturn(run func() Name) *DisplaySourceMock_GetName_Call {
	_c.Call.Return(run)
	return _c
}
